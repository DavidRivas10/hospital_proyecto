...
import { triageSchema, type TriageFormData } from "../validation/traige"; // usa el path que ya te compila
...
export default function TriageForm() {
  ...
  const onSubmit: SubmitHandler<TriageFormData> = async (values) => {
    // FIX puntual: castear para evitar conflicto de tipos con la firma de triageCreate
  ...
  // Para el <Select> de urgencia usando Mantine controlado:
